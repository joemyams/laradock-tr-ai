...
const DropdownSelect = ({ disabled, options, value, onChange }) => {
  ...
  return (
    <select
      ...
      className="pl-2 r-4 appearance-none border border-gray-300 round text-gray-500 leading-tight focus:outline-none focus:border-blue-500 w-40"
    >
